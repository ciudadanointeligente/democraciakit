...
urlpatterns = [
    ...
    path(
        ...
        name="etapa1-conceptos",
    ),
    path(
        "etapa1-definicion/",
        views.Definicion1CreateView.as_view(),
        name="etapa1-definicion",
    ),
    path(
        "etapa1-estrategia/",
        views.Etapa1EstrategiaView.as_view(),
        name="etapa1-estrategia",
    ),
    ...
    path(
        "etapa2-mapaafinidad/",
        views.MapaAfinidad2CreateView.as_view(),
        name="etapa2-mapaafinidad",
    ),
    path(
        "etapa2-inclusivo/",
        views.Inclusivo2CreateView.as_view(),
        name="etapa2-inclusivo",
    ),
    path(
        "etapa2-identificacion/",
        views.IdentificacionCreateView.as_view(),
        name="etapa2-identificacion",
    ),
    path("etapa3/", views.Etapa3View.as_view(), name="etapa3"),
    path("etapa3-3x3x3/", views.Etapa33x3x3View.as_view(), name="etapa3-3x3x3"),
    path(
        "etapa3-sombreros/",
        views.Etapa3SombrerosView.as_view(),
        name="etapa3-sombreros",
    ),
    path(
        "etapa3-reflexionar/",
        views.Etapa3ReflexionarView.as_view(),
        name="etapa3-reflexionar",
    ),
    path("etapa3-smart/", views.Etapa3SmartView.as_view(), name="etapa3-smart"),
    path("etapa4/", views.Etapa4View.as_view(), name="etapa4"),
    path(
        "etapa4-proyeccion/",
        views.Etapa4ProyeccionView.as_view(),
        name="etapa4-proyeccion",
    ),
    path(
        "etapa4-mapaactores/",
        views.Etapa4MapaactoresView.as_view(),
        name="etapa4-mapaactores",
    ),
    path("etapa4-eventos/", views.Etapa4EventosView.as_view(), name="etapa4-eventos"),
    path(
        "etapa4-oportunidades/",
        views.Etapa4OportunidadesView.as_view(),
        name="etapa4-oportunidades",
    ),
    path(
        "etapa4-plandetrabajo/",
        views.Etapa4PlandetrabajoView.as_view(),
        name="etapa4-plandetrabajo",
    ),
    path("etapa5/", views.Etapa5View.as_view(), name="etapa5"),
    path(
        "etapa5-keepfixtry/",
        views.Etapa5KeepfixtryView.as_view(),
        name="etapa5-keepfixtry",
    ),
    path(
        "etapa5-impulsores/",
        views.Etapa5ImpulsoresView.as_view(),
        name="etapa5-impulsores",
    ),
    ...
    path(
        "etapa7-evaluacion/",
        views.Etapa7EvaluacionView.as_view(),
        name="etapa7-evaluacion",
    ),
    path(
        "etapa7-indicadores/",
        views.Etapa7IndicadoresView.as_view(),
        name="etapa7-indicadores",
    ),
    ...
    path(
        "reflexionesedit/", views.ReflexionesEditView.as_view(), name="reflexionesedit"
    ),
    path(
        "mapaafinidadedit/",
        views.MapaAfinidad2EditView.as_view(),
        name="mapaafinidadedit",
    ),
    path(
        "oportunidadesedit/",
        views.OportunidadesEditView.as_view(),
        name="oportunidadesedit",
    ),
    path(
        "eventosedit/",
