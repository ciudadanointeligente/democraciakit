...
urlpatterns = [
    ...
    path('etapa2-mapaafinidad/', views.Etapa2MapaAfinidadView.as_view(), name='etapa2-mapaafinidad'),
    path('etapa2-inclusivo/', views.Etapa2InclusivoView.as_view(), name='etapa2-inclusivo'),
    path('etapa2-identificacion/', views.Etapa2IdentificacionView.as_view(), name='etapa2-identificacion'),
